...
- If you add a quantity field in the plugin studio, this field will now be used to determine the quantity that needs to be added to the Shopware cart
...
**Changed**
- Use the LanguageLocaleCodeProvider to determine the language code for the feed on other places as well.
...
**Fixed**
- Fixed wrong name of finalize-transaction rout
