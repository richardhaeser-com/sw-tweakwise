...
class FeedDefinition extends EntityDefinition
{
    ...
    protected function defineFields(): FieldCollection
    {
        return new FieldCollection([
            ...
            (new BoolField('excludeChildren', 'excludeChildren'))->addFlags(new ApiAware()),
            (new BoolField('excludeReviews', 'excludeReviews'))->addFlags(new ApiAware()),
            ...
            (new BoolField('respectHideCloseoutProductsWhenOutOfStock', 'respectHideCloseoutProductsWhenOutOfStock'))->addFlags(new ApiAware()),
