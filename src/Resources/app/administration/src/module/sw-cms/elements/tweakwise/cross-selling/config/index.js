...
Shopware.Component.register('sw-cms-el-config-tweakwise-cross-selling', {
    ...
    computed: {
        ...
        viewOptions() {
            return [
                { value: 'carousel', label: this.$tc('sw-cms.elements.tweakwiseCrossSelling.config.view.carousel') },
                { value: 'grid', label: this.$tc('sw-cms.elements.tweakwiseCrossSelling.config.view.grid') },
            ];
        }
    },
